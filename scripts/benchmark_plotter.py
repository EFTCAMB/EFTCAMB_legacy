...
for res in sorted_benchmark_results_keys:
    ...
    y     = [ temp[0] for temp in [ benchmark_results[res].models_rel_b[key] for key in labels ] ]
    y_err = [ temp[1] for temp in [ benchmark_results[res].models_rel_b[key] for key in labels ] ]
    # plot:
    fig, ax = plt.subplots()
